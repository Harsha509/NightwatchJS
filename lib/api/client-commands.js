...
module.exports = function(client) {
  return {
    ...
    /**
     * Convenience method that adds the specified hash (i.e. url fragment) to the current value of the `launch_url` as set in `nighwatch.json`.
     *
     * ```
     * this.demoTest = function (client) {
     ...
     *
     * @method urlHash
     * @param {string} hash The hash to add/replace to the current url (i.e. the value set in the launch_url property in nighwatch.json).
     * @see url
     * @since v0.4.0
     * @api commands
     */
